...
while robot.step(timestep) != -1:
    ...
    # =============================
        ...
        # Steering logic
        if green_pos == "LEFT":
            left_motor.setVelocity(0.5 * FORWARD_SPEED)
            right_motor.setVelocity(0.8 * FORWARD_SPEED)

        elif green_pos == "RIGHT":
            left_motor.setVelocity(0.8 * FORWARD_SPEED)
            right_motor.setVelocity(0.5 * FORWARD_SPEED)
